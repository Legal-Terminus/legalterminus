...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Register Google user in Firestore if not already registered
      // This creates the users/{uid} document with role='client' if needed
      try {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 py-8">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        <h1 className="text-2xl font-bold text-blue-700 mb-1">Legal Terminus</h1>
        <p className="text-sm text-gray-500 mb-6">Workflow Management Portal</p>
        ...
        <button
          ...
          disabled={loading}
          className="w-full mt-4 flex items-center justify-center gap-2 border border-gray-300 rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
        >
