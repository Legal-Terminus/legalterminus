...
import "./IncreaseOurclints.css";

import { clientLogos } from "../../assets/clientLogos.js";

const IncreaseOurclints = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".Increase-clients-card");
  ...
  return (
    <section className="Increase-clients-root">
      <div className="Increase-clients-container">
        <h2 className="Increase-clients-title">OUR CLIENTS</h2>

        <div className="Increase-clients-carousel">
          <button className="Increase-clients-arrow Increase-clients-arrow-left"
          ...
          <div className="Increase-clients-scroller">
            <ul className="Increase-clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="Increase-clients-card" key={`logo-${i}`}>
                  <figure className="Increase-clients-logo">
                    <img src={src} alt={`client-${i}`} className="Increase-clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="Increase-clients-arrow Increase-clients-arrow-right"
...
export default IncreaseOurclints;
