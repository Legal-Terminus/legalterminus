        ...
        <div className="DP-pricing-cards">
          ...
          <article className="DP-plan-card">
            ...
            <div className="DP-plan-footer">
              <button className="DP-plan-button" onClick={() => setActivePlan(PLANS[0])}>Buy Now</button>
            </div>
          </article>
          ...
          <article className="DP-plan-card">
            ...
            <div className="DP-plan-footer">
              <button className="DP-plan-button" onClick={() => setActivePlan(PLANS[1])}>Buy Now</button>
            </div>
          </article>
          ...
          <article className="DP-plan-card">
            ...
            <div className="DP-plan-footer">
              <button className="DP-plan-button" onClick={() => setActivePlan(PLANS[2])}>Buy Now</button>
            </div>
          </article>
