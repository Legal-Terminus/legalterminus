...
const OurClients = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".Windup-PLC-clients-card");
  ...
  return (
    <section className="Windup-PLC-clients-root">
      <div className="Windup-PLC-clients-container">
        <h2 className="Windup-PLC-clients-title">OUR CLIENTS</h2>

        <div className="Windup-PLC-clients-carousel">
          <button className="Windup-PLC-clients-arrow Windup-PLC-clients-arrow-left"
          ...
          <div className="Windup-PLC-clients-scroller">
            <ul className="Windup-PLC-clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="Windup-PLC-clients-card" key={`logo-${i}`}>
                  <figure className="Windup-PLC-clients-logo">
                    <img src={src} alt={`client-${i}`} className="Windup-PLC-clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="Windup-PLC-clients-arrow Windup-PLC-clients-arrow-right"
