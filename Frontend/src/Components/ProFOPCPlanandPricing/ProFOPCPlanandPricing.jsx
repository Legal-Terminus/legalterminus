          ...
          <article className="profopc-plan-card">
            <div>
              <div className="profopc-plan-header">
                ...
                <div className="profopc-plan-price">{PLANS[0].price.toLocaleString("en-IN")}</div>
            ...
            <div className="profopc-plan-footer">
              <button className="profopc-plan-button" onClick={() => setActivePlan(PLANS[0])}>Buy Now</button>
            </div>
          </article>
          ...
          <article className="profopc-plan-card">
            <div>
              <div className="profopc-plan-header">
                ...
                <div className="profopc-plan-price">{PLANS[1].price.toLocaleString("en-IN")}</div>
            ...
            <div className="profopc-plan-footer">
              <button className="profopc-plan-button" onClick={() => setActivePlan(PLANS[1])}>Buy Now</button>
            </div>
          </article>
          ...
          <article className="profopc-plan-card">
            <div>
              <div className="profopc-plan-header">
                ...
                <div className="profopc-plan-price">{PLANS[2].price.toLocaleString("en-IN")}</div>
                <div className="profopc-plan-meta">Excluding gov fee</div>
              </div>
            ...
            <div className="profopc-plan-footer">
              <button className="profopc-plan-button" onClick={() => setActivePlan(PLANS[2])}>Buy Now</button>
            </div>
          </article>
