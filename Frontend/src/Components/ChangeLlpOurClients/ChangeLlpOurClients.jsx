...
import "./ChangeLlpOurClients.css";
...
const OurClients = () => {
  ...
  return (
    <section className="Change-llp-clients-root">
      <div className="Change-llp-clients-container">
        <h2 className="Change-llp-clients-title">OUR CLIENTS</h2>

        <div className="Change-llp-clients-carousel">
          <button className="Change-llp-clients-arrow clients-arrow-left"
          ...
          <div className="Change-llp-clients-scroller">
            <ul className="Change-llp-clients-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="Change-llp-clients-card" key={`logo-${i}`}>
                  <figure className="Change-llp-clients-logo">
                    <img src={src} alt={`client-${i}`} className="Change-llp-clients-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="Change-llp-clients-arrow clients-arrow-right"
