...
import "./PtopvtGovtCosts.css";

const rows = [
  {
    head: "DSC for Directors (2 nos.)",
    range: "₹2,000 – ₹4,000",
    note: "Digital Signature Certificates required for the minimum two directors",
  },
  {
  ...
  {
    head: "Stamp Duty (MOA / AOA / Transfer)",
    range: "₹1,000 – ₹5,000+",
    note: "State-specific stamp duty on incorporation docs and the asset-transfer agreement",
  },
  {
...
export default PtopvtGovtCosts;
