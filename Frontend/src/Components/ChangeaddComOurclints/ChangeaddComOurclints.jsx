...
import "./ChangeaddComOurclints.css";

import { clientLogos } from "../../assets/clientLogos.js";

const ChangeaddComOurclints = () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".Change-add-com-Oc-card");
  ...
  return (
    <section className="Change-add-com-Oc-root">
      <div className="Change-add-com-Oc-container">
        <h2 className="Change-add-com-Oc-title">OUR CLIENTS</h2>

        <div className="Change-add-com-Oc-carousel">
          <button className="Change-add-com-Oc-arrow Change-add-com-Oc-arrow-left"
          ...
          <div className="Change-add-com-Oc-scroller">
            <ul className="Change-add-com-Oc-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="Change-add-com-Oc-card" key={`logo-${i}`}>
                  <figure className="Change-add-com-Oc-logo">
                    <img src={src} alt={`client-${i}`} className="Change-add-com-Oc-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="Change-add-com-Oc-arrow Change-add-com-Oc-arrow-right"
...
export default ChangeaddComOurclints;
