...
import "./ChangeObjectComTestimonial.css";
...
const ChangeObjectComTestimonial= () => {
  ...
  const handleScroll = (direction) => {
    ...
    const card = container.querySelector(".Change-ob-tm-card");
    if (!card) return;
  ...
  return (
    <section className="Change-ob-tm-section">
      <div className="Change-ob-tm-container">
        <h2 className="Change-ob-tm-heading">
          See What Our Customers Say on Google
        </h2>

        <div className="Change-ob-tm-slider-wrapper">
          {/* Left arrow */}
          <button
            className="Change-ob-tm-side-arrow Change-ob-tm-left"
          ...
          {/* Cards slider */}
          <div className="Change-ob-tm-slider" ref={sliderRef}>
            {testimonials.map((t, idx) => (
              <article className="Change-ob-tm-card" key={idx}>
                {/* top quote */}
                <span className="Change-ob-tm-quote Change-ob-tm-quote-top">“</span>

                {/* avatar */}
                <div className="Change-ob-tm-avatar-wrap">
                  <div className="Change-ob-tm-avatar">
                    <span>{t.initial}</span>
                  </div>
                </div>

                {/* text */}
                <p className="Change-ob-tm-text">{t.text}</p>

                {/* name & role */}
                <h3 className="Change-ob-tm-name">{t.name}</h3>
                <p className="Change-ob-tm-role">{t.role}</p>

                {/* stars */}
                <div className="Change-ob-tm-stars">
                ...
                {/* bottom quote */}
                <span className="Change-ob-tm-quote Change-ob-tm-quote-bottom">”</span>
              </article>
            ))}
          </div>
          ...
          {/* Right arrow */}
          <button
            className="Change-ob-tm-side-arrow Change-ob-tm-right"
...
export default ChangeObjectComTestimonial;
