...
const AddTestimonial = () => {
  ...
  return (
    <section className="Add-Process-gt-section">
      <div className="Add-Process-gt-container">
        <h2 className="Add-Process-gt-heading">
          See What Our Customers Say on Google
        </h2>

        <div className="Add-Process-gt-slider-wrapper">
          {/* Left arrow */}
          <button
            className="Add-Process-gt-side-arrow gt-left"
          ...
          {/* Cards slider */}
          <div className="Add-Process-gt-slider" ref={sliderRef}>
            {testimonials.map((t, idx) => (
              <article className="Add-Process-gt-card" key={idx}>
                {/* top quote */}
                <span className="Add-Process-gt-quote gt-quote-top">“</span>

                {/* avatar */}
                <div className="Add-Process-gt-avatar-wrap">
                  <div className="Add-Process-gt-avatar">
                    <span>{t.initial}</span>
                  </div>
                </div>

                {/* text */}
                <p className="Add-Process-gt-text">{t.text}</p>

                {/* name & role */}
                <h3 className="Add-Process-gt-name">{t.name}</h3>
                <p className="Add-Process-gt-role">{t.role}</p>

                {/* stars */}
                <div className="Add-Process-gt-stars">
                ...
                {/* bottom quote */}
                <span className="Add-Process-gt-quote gt-quote-bottom">”</span>
              </article>
            ))}
          </div>
          ...
          {/* Right arrow */}
          <button
            className="Add-Process-gt-side-arrow gt-right"
