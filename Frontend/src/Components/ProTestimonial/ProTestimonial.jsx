...
const testimonials = [
  ...
  },
  {
    ...
    text: "We are glad to share that our company Ephorsys Private Limited was successfully incorporated with the support of Legal Terminus. Their team provided excellent guidance throughout the entire process—from documentation to final approval. Everything was handled smoothly, professionally, and on time.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Working with Legal Terminus for our annual compliances has been a seamless experience. Their knowledgeable team handled everything efficiently, ensuring we met all our regulatory requirements on time. Highly recommend their services!",
    rating: 5,
  ...
  },
  {
    ...
    text: "Like the professional approach to the client. Proper follow ups and right information given to the client in utmost care. Thank you the entire team for the extreme support and care.",
    rating: 5,
  ...
  },
  {
    ...
    text: "ROOTAMZ PRIVATE LIMITED had a wonderful experience working with Legal Terminus. Their team was highly professional, cooperative, and dedicated to delivering quality service throughout. Communication was smooth, transparent, and timely at every stage.",
    rating: 5,
    reviewUrl: "https://share.google/7K1z1CdCoR7nMuL0h",
  },
  {
    name: "Kanhu Charan Dash",
    role: "VAIDYA SETU HEALTH AND WELLNESS",
    text: "Excellent experience with Legal Terminus for Private Limited Company registration. Their team handled the complete process professionally and completed everything on time. Communication was smooth, quick, and helpful throughout.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Thank you for the smooth company registration service. The team was supportive, responsive, and completed all formalities within the promised timeline. They kept us informed at every stage. Great experience overall.",
    rating: 5,
...
const ProTestimonial = () => {
  ...
  useEffect(() => {
    if (isPaused) return;
    const id = setInterval(() => setActive((i) => wrap(i + 1, n)), 1200);
    return () => clearInterval(id);
  }, [isPaused]);

  const slots = [
    { slotKey: "left",   t: testimonials[prev],   pos: "side" },
    { slotKey: "center", t: testimonials[active], pos: "center" },
    { slotKey: "right",  t: testimonials[next],   pos: "side" },
  ];
