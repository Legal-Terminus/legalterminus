...
import "./IncreaseTestimonial.css";
...
const IncreaseTestimonial = () => {
  ...
  const handleScroll = (direction) => {
    ...
    const card = container.querySelector(".Increase-Testi-gt-card");
    if (!card) return;
  ...
  return (
    <section className="Increase-Testi-gt-section">
      <div className="Increase-Testi-gt-container">
        <h2 className="Increase-Testi-gt-heading">
          See What Our Customers Say on Google
        </h2>

        <div className="Increase-Testi-gt-slider-wrapper">
          {/* Left arrow */}
          <button
            className="Increase-Testi-gt-side-arrow Increase-Testi-gt-left"
          ...
          {/* Cards slider */}
          <div className="Increase-Testi-gt-slider" ref={sliderRef}>
            {testimonials.map((t, idx) => (
              <article className="Increase-Testi-gt-card" key={idx}>
                {/* top quote */}
                <span className="Increase-Testi-gt-quote Increase-Testi-gt-quote-top">“</span>

                {/* avatar */}
                <div className="Increase-Testi-gt-avatar-wrap">
                  <div className="Increase-Testi-gt-avatar">
                    <span>{t.initial}</span>
                  </div>
                </div>

                {/* text */}
                <p className="Increase-Testi-gt-text">{t.text}</p>

                {/* name & role */}
                <h3 className="Increase-Testi-gt-name">{t.name}</h3>
                <p className="Increase-Testi-gt-role">{t.role}</p>

                {/* stars */}
                <div className="Increase-Testi-gt-stars">
                ...
                {/* bottom quote */}
                <span className="Increase-Testi-gt-quote Increase-Testi-gt-quote-bottom">”</span>
              </article>
            ))}
          </div>
          ...
          {/* Right arrow */}
          <button
            className="Increase-Testi-gt-side-arrow Increase-Testi-gt-right"
...
export default IncreaseTestimonial;
