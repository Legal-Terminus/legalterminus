...
import "./ChangeObjectComOurclints.css";

import { clientLogos } from "../../assets/clientLogos.js";

const ChangeObjectComOurclints= () => {
  ...
  const scrollByCard = (dir) => {
    ...
    const scroller = track.parentElement;
    const card = track.querySelector(".Change-ob-oc-card");
  ...
  return (
    <section className="Change-ob-oc-root">
      <div className="Change-ob-oc-container">
        <h2 className="Change-ob-oc-title">OUR CLIENTS</h2>

        <div className="Change-ob-oc-carousel">
          <button className="Change-ob-oc-arrow Change-ob-oc-arrow-left"
          ...
          <div className="Change-ob-oc-scroller">
            <ul className="Change-ob-oc-track" ref={trackRef}>
              {logosDup.map((src, i) => (
                <li className="Change-ob-oc-card" key={`logo-${i}`}>
                  <figure className="Change-ob-oc-logo">
                    <img src={src} alt={`client-${i}`} className="Change-ob-oc-img" />
                  </figure>
                </li>
              ))}
            </ul>
          ...
          <button className="Change-ob-oc-arrow Change-ob-oc-arrow-right"
...
export default ChangeObjectComOurclints;
