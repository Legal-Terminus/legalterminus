...
import "./ChangeaddComTestimonial.css";
...
const GoogleTestimonials = () => {
  ...
  const handleScroll = (direction) => {
    ...
    const card = container.querySelector(".Change-add-com-Tm-card");
    if (!card) return;
  ...
  return (
    <section className="Change-add-com-Tm-section">
      <div className="Change-add-com-Tm-container">
        <h2 className="Change-add-com-Tm-heading">
          See What Our Customers Say on Google
        </h2>

        <div className="Change-add-com-Tm-slider-wrapper">
          {/* Left arrow */}
          <button
            className="Change-add-com-Tm-side-arrow Change-add-com-Tm-left"
          ...
          {/* Cards slider */}
          <div className="Change-add-com-Tm-slider" ref={sliderRef}>
            {testimonials.map((t, idx) => (
              <article className="Change-add-com-Tm-card" key={idx}>
                {/* top quote */}
                <span className="Change-add-com-Tm-quote Change-add-com-Tm-quote-top">“</span>

                {/* avatar */}
                <div className="Change-add-com-Tm-avatar-wrap">
                  <div className="Change-add-com-Tm-avatar">
                    <span>{t.initial}</span>
                  </div>
                </div>

                {/* text */}
                <p className="Change-add-com-Tm-text">{t.text}</p>

                {/* name & role */}
                <h3 className="Change-add-com-Tm-name">{t.name}</h3>
                <p className="Change-add-com-Tm-role">{t.role}</p>

                {/* stars */}
                <div className="Change-add-com-Tm-stars">
                ...
                {/* bottom quote */}
                <span className="Change-add-com-Tm-quote Change-add-com-Tm-quote-bottom">”</span>
              </article>
            ))}
          </div>
          ...
          {/* Right arrow */}
          <button
            className="Change-add-com-Tm-side-arrow Change-add-com-Tm-right"
