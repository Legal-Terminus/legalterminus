...
import "../CompanyRegWhyChoose/CompanyRegWhyChoose.css";

const ITEMS = [
  {
    title: "Affordable & Transparent Pricing",
    text: "Trademark filing starting at ₹1,499.",
    icon: (
  ...
  {
    title: "Hassle-Free Filing Support",
    text: "We handle the complete TM-A process, from search to filing on the IP India portal.",
    icon: (
  ...
  },
  {
    ...
    text: "Monthly status updates on your application — for its entire lifecycle.",
    icon: (
  ...
  },
  {
    ...
    text: "Dedicated assistance for businesses and brands operating in Odisha.",
    icon: (
      <svg viewBox="0 0 24 24" width="29" height="29" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const TrademarkWhyChoose = () => {
  return (
    <section className="crwc-section">
      <div className="crwc-container">
        <h2 className="crwc-heading">
          Why Choose <span>Legal Terminus</span> for Trademark Registration?
        </h2>
...
export default TrademarkWhyChoose;
